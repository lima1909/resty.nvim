...
describe("read line", function()
	it("ignore line", function()
		assert.is_false(p.new():read_line("#", do_nothing_parser))
		assert.is_false(p.new():read_line("# text", do_nothing_parser))
		assert.is_false(p.new():read_line("", do_nothing_parser))
		assert.is_false(p.new():read_line(" ", do_nothing_parser))
		assert.is_false(p.new():read_line("###", do_nothing_parser))
		assert.is_false(p.new():read_line("{{foo", do_nothing_parser, true))

		assert.is_true(p.new():read_line("{{foo", do_nothing_parser))
	end)

	it("parse valid line", function()
